...
namespace Tactics.Weapons
{
    ...
    public class WeaponInventory : NetworkBehaviour
    {
        ...
        private void Update()
        {
            ...
            // Planting/defusing holds both hands, and an open menu holds the
            // keyboard: no swapping slots, the spike slot included. Guarded at
            // the input rather than inside SwitchTo so scripted equips (buy menu,
            // spike fallback) are unaffected.
